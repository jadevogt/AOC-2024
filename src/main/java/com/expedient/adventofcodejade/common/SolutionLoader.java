...
/**
 * Class responsible for dynamically loading Solutions located in <code>com.expedient.adventofcodejade.solutions</code>.
 */
public class SolutionLoader {
     ...
     * @return The BaseSolution instance for the given day, located in the day's respective package as a class named
     * "Solution"
    ...
    /**
     * Tries to get solutions for days 1-25, breaks out of the loop is any are missing. There should never be
     * more than 25 days before Christmas lol
